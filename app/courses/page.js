    ...
    <main style={{ minHeight: "100vh", backgroundColor: "#FAF5EE", display: "flex", flexDirection: "column" }}>
      ...
      <section style={{
        ...
        <div
          style={{
            ...
            maxWidth: "1200px",
            margin: "0 auto",
            backgroundColor: "rgba(201, 155, 77, 0.01)",
            borderRadius: "16px",
            border: "1.5px dashed rgba(201, 155, 77, 0.6)",
            padding: "20px 24px",
            boxSizing: "border-box",
            display: "flex",
            flexDirection: "column",
          ...
          onMouseOver={(e) => {
            e.currentTarget.style.backgroundColor = "rgba(201, 155, 77, 0.03)";
            e.currentTarget.style.borderColor = "#C99B4D";
          }}
          onMouseOut={(e) => {
            e.currentTarget.style.backgroundColor = "rgba(201, 155, 77, 0.01)";
            e.currentTarget.style.borderColor = "rgba(201, 155, 77, 0.6)";
          }}
        >
      ...
      <section style={{
        ...
        <div className="cta-banner-wrapper" style={{
          ...
          {/* Left Portion (Large Logo Emblem + Text Content + Badges) */}
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                gap: "10px",
                cursor: "pointer",
                boxShadow: "0 6px 20px rgba(201, 155, 77, 0.2)",
              ...
              onMouseOver={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 8px 24px rgba(201, 155, 77, 0.25)";
              }}
              onMouseOut={(e) => {
                e.currentTarget.style.backgroundColor = "#C99B4D";
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow = "0 6px 20px rgba(201, 155, 77, 0.2)";
              }}
            >
