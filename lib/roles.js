...
export const ROLE_PRESETS = {
  ...
  content_editor: { label: "Content Editor", tabs: ["overview", "blogs", "pages", "courses", "testimonials", "teachers", "seo", "footer"], manageStaff: false, desc: "Manages website content, courses, blogs and SEO." },
  support: { label: "Support Agent", tabs: ["overview", "contacts", "liveChat", "freeTrials", "teacherApps", "studentApps"], manageStaff: false, desc: "Handles inquiries, live chat, bookings and applications." },
  seo_specialist: { label: "SEO Specialist", tabs: ["overview", "seo", "pages", "blogs"], manageStaff: false, desc: "Manages SEO, page content and blog articles." },
