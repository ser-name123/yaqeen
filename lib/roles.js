...
export const ROLE_PRESETS = {
  ...
  content_editor: { label: "Content Editor", tabs: ["overview", "landingPages", "blogs", "pages", "courses", "testimonials", "teachers", "seo", "footer"], manageStaff: false, desc: "Manages website content, landing pages, courses, blogs and SEO." },
