...
export const SEO_PAGE_LIST = [
  ...
  { key: "bookTrial", label: "Register (Free Trial)", path: "/register" },
  { key: "teacherApplication", label: "Teacher Application", path: "/teacher-application" },
  ...
  { key: "cookies", label: "Cookies Policy", path: "/cookies" },
];
...
export const PAGE_SEO_DEFAULTS = {
  ...
  bookTrial: {
    slug: "/register",
    title: "Register for Free Trial Class — Yaqeen Institute",
    description: "Register for your free trial class today. 100% free, no card needed, flexible 24/7 scheduling with certified teachers.",
    keywords: "free Quran trial class, register Quran class, free trial, online Quran demo, yaqeen registration",
  },
  teacherApplication: {
    slug: "/teacher-application",
    title: "Teacher Application — Join Our Academic Team | Yaqeen Institute",
    description: "Apply as a certified Quran, Arabic or Islamic Studies online tutor. Flexible teaching schedules with competitive hourly pay.",
    keywords: "apply as teacher, quran teacher application, teach quran online, yaqeen institute tutor",
  },
  privacy: {
    slug: "/privacy",
  ...
  refund: {
    slug: "/refund",
    title: "Refund Policy — Yaqeen Institute",
    description: "Our clear, transparent refund policy and money-back guarantee for online Quran and Islamic courses.",
    keywords: "refund policy, money back guarantee, Yaqeen Institute refund, tuition cancellation",
  },
  cookies: {
    slug: "/cookies",
    title: "Cookies Policy — Yaqeen Institute",
    description: "Learn how Yaqeen Institute uses cookies and tracking technologies to improve your educational browsing experience.",
    keywords: "cookies policy, cookie settings, tracking technologies, Yaqeen Institute cookies",
  },
};
