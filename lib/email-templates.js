...
<a href="https://www.yaqeeninstitute.online/privacy-policy">Privacy Policy</a> | <a href="https://www.yaqeeninstitute.online/terms-and-conditions">Terms &amp; Conditions</a><br>
...
<div class="links">
<a href="https://www.yaqeeninstitute.online/privacy-policy">Privacy Policy</a> |
<a href="https://www.yaqeeninstitute.online/terms-and-conditions">Terms &amp; Conditions</a>
</div>
...
export function freeTrialUserEmail({ form, settings, siteUrl }) {
  ...
  const formattedDateTime = `Requested Date: ${escapeHtml(form.date || "TBD")} &nbsp;&nbsp;·&nbsp;&nbsp; Time: ${escapeHtml(time || "TBD")}`;
...
<a href="https://wa.me/447700183406">+44 7700 183406</a>
</div>
...
<tr><td>When do you want to start?</td><td>${escapeHtml(form.date || "TBD")}</td></tr>
...
export function studentAppUserEmail({ form, settings, siteUrl }) {
  ...
  const startDateTime = `${form.preferred_date || "TBD"} · ${form.preferred_time || "TBD"}`;
...
<tr><td>Preferred Days</td><td>${escapeHtml(daysString)}</td></tr>
<tr><td>Class Start Date</td><td>${escapeHtml(form.preferred_date || "")}</td></tr>
