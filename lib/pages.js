...
export const PAGE_DEFAULTS = {
  ...
  teachers: {
    ...
    choose: {
      ...
      cards: [
        { title: "I want to learn the Quran", desc: "Join interactive Quran classes online with expert teachers and a proven curriculum designed for all age groups and levels.", btn: "Register as Student", href: "/book-free-trial" },
