...
export default function LandingPageTemplate({ initialPage }) {
  ...
  return (
    <div style={{ backgroundColor: "#FFFFFF", background: "#FFFFFF", minHeight: "100vh", color: "#2B1F14", fontFamily: "var(--font-poppins), sans-serif" }}>
      <style>{`
        .lp-rich-text {
          display: block;
          width: 100%;
      ...
      {/* =========================================================================
         ...
         ========================================================================= */}
      <section style={{ background: "#FFFFFF", padding: "20px 0", position: "relative" }}>
        <div style={{ maxWidth: "1350px", width: "100%", margin: "0 auto", boxSizing: "border-box" }} className="landing-container">
          ...
          <div 
            ...
            className="landing-hero-card-wrapper scroll-reveal"
          >
            ...
            >
                ...
                {trustStripItems.map((item, idx) => (
                  <div 
                    ...
                    style={{
                      ...
                      borderLeft: idx === 0 ? "none" : "1px solid #EADDC8"
                    }}
              ...
              >
                ...
                <div style={{ width: "1px", height: "46px", backgroundColor: "#EADDC8" }} className="strip-right-divider" />
                <div>
      ...
      <section style={{ background: "#FFFFFF", padding: "20px 0", position: "relative" }}>
        <div style={{ maxWidth: "1350px", width: "100%", margin: "0 auto", boxSizing: "border-box" }} className="landing-container">
          ...
          <div 
            ...
            className="why-choose-card-wrapper scroll-reveal"
          >
            {/* Top Dot Pattern Accent */}
            <div style={{
              position: "absolute",
            ...
            <div style={{ marginBottom: "22px", position: "relative", zIndex: 1 }} className="scroll-reveal">
              <h2 style={{ 
            ...
            {/* Lead Intro Text */}
            <div style={{ marginBottom: "32px", maxWidth: "980px", position: "relative", zIndex: 1 }} className="scroll-reveal delay-1">
              <div style={{ 
            ...
            >
              {whyFeatures.map((feat, idx) => (
                ...
                >
                  ...
                  <div>
                    <h3 style={{ fontSize: "14.5px", fontWeight: "700", color: "#2B1F14", margin: "0 0 4px 0", lineHeight: "1.3" }}>
                      {feat.title}
                    </h3>
                    <div style={{ fontSize: "12px", lineHeight: "1.55", color: "#5C4D3C", margin: 0 }}>
      ...
      <section style={{ background: "#FFFFFF", padding: "20px 0", position: "relative" }}>
        <div style={{ maxWidth: "1350px", width: "100%", margin: "0 auto", boxSizing: "border-box" }} className="landing-container">
          ...
          <div 
            ...
            className="diff-card-wrapper scroll-reveal"
          >
            {/* Top Dot Pattern Accent */}
            <div style={{
              position: "absolute",
            ...
            >
                  ...
                  {diffCenterPillars.map((pillar, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ fontSize: "10px", color: "#7C7267", margin: 0, lineHeight: "1.3" }}>
                          {renderRichText(pillar.description)}
                        </div>
                      </div>
                    );
                  })}
              ...
              >
                <div>
                  ...
                  <div style={{ fontSize: "12px", lineHeight: "1.6", color: "#E5EBDD", margin: "0 0 24px 0" }}>
                    {renderRichText(diffRight.description, "Join thousands of families worldwide who trust Yaqeen Institute for authentic, high-quality, and personalized Quran education.")}
                  </div>
                </div>
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: "10px", color: "#7C7267", margin: 0, lineHeight: "1.3" }}>
                    {renderRichText(ukTrust.bottomStrip?.item1Desc, "Take the first step towards a brighter future with quality, flexible, and personalized Quran education.")}
                  </div>
                </div>
              </div>

              {/* Divider */}
              <div style={{ width: "1px", height: "38px", backgroundColor: "#EADDC8" }} className="uk-bar-divider" />
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: "10px", color: "#7C7267", margin: 0, lineHeight: "1.3" }}>
                    {renderRichText(ukTrust.bottomStrip?.item2Desc, "A trusted learning environment for your peace of mind.")}
                  </div>
                </div>
              </div>
              ...
              {/* Segment 4 */}
              <div style={{ display: "flex", alignItems: "center", gap: "10px", borderLeft: "1px solid #EADDC8", paddingLeft: "16px" }} className="uk-bar-right-item">
                <div style={{
                  width: "32px",
                  height: "32px",
                  borderRadius: "50%",
      ...
      <section style={{ background: "#FFFFFF", padding: "20px 0", position: "relative" }}>
        <div style={{ maxWidth: "1350px", width: "100%", margin: "0 auto", boxSizing: "border-box" }} className="landing-container">
          ...
          <div 
            ...
            className="courses-card-wrapper scroll-reveal"
          >
            {/* Top Dot Pattern Accent */}
            <div style={{
              position: "absolute",
            ...
            {/* Section Header */}
            <div style={{ textAlign: "center", marginBottom: "32px", position: "relative", zIndex: 1 }} className="scroll-reveal">
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", flex: "1 1 auto", minWidth: "280px" }} className="courses-bar-left">
                ...
                {/* Left Divider */}
                <div style={{ width: "1px", height: "30px", backgroundColor: "#EADDC8", margin: "0 14px", flexShrink: 0 }} className="courses-bar-divider" />
              ...
              <div style={{ display: "flex", alignItems: "center", flexShrink: 0 }} className="courses-bar-right">
                ...
                {/* Right Divider */}
                <div style={{ width: "1px", height: "30px", backgroundColor: "#EADDC8", margin: "0 18px", flexShrink: 0 }} className="courses-bar-divider" />
      ...
      <section style={{ background: "#FFFFFF", padding: "20px 0", position: "relative" }}>
        <div style={{ maxWidth: "1350px", width: "100%", margin: "0 auto", boxSizing: "border-box" }} className="landing-container">
          ...
          <div 
            ...
            className="journey-card-wrapper scroll-reveal"
          >
            {/* Top Dot Pattern Accent */}
            <div style={{
              position: "absolute",
            ...
            <div style={{ textAlign: "center", marginBottom: "36px", position: "relative", zIndex: 1 }} className="scroll-reveal">
              ...
              {(journey.pillars || DEFAULT_LANDING_PAGE_CONTENT.journey.pillars || []).map((pil, idx) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "10px", color: "#7C7267", margin: 0, lineHeight: "1.3", whiteSpace: "pre-line" }}>
                      {renderRichText(pil.subtitle)}
                    </div>
                  </div>
                </div>
              ))}
      ...
      {/* =========================================================================
         SECTION 7: FAQS
         ========================================================================= */}
      <section style={{ background: "#FFFFFF", padding: "20px 0 48px 0", position: "relative" }}>
        <div style={{ maxWidth: "1350px", width: "100%", margin: "0 auto", boxSizing: "border-box" }} className="landing-container">
          ...
          <div 
            ...
            className="faqs-card-wrapper scroll-reveal"
          >
            {/* Top Dot Pattern Accent */}
            <div style={{
              position: "absolute",
            ...
            <div style={{ textAlign: "center", marginBottom: "32px", position: "relative", zIndex: 1 }} className="scroll-reveal">
              ...
              <div style={{ fontSize: "13.5px", color: "#5C4D3C", margin: "0 auto", maxWidth: "600px", lineHeight: "1.5" }}>
                {renderRichText(faqs.subtitle || "Everything you need to know about our online Quran classes.")}
              </div>
            </div>

            {/* FAQ Rows Grid */}
            <div style={{ display: "flex", flexDirection: "column", gap: "12px", maxWidth: "1150px", margin: "0 auto", position: "relative", zIndex: 1 }}>
              {faqList.map((faq, idx) => (
                <div 
                  key={faq.id || idx}
                  style={{
                ...
                >
                  ...
                  <div style={{ width: "1px", height: "36px", backgroundColor: "#EADDC8", flexShrink: 0 }} className="faq-card-divider" />
